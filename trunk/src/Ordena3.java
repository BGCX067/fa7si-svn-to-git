...
public class Ordena3 {
	...
	public static void main(String[] args) {
		...
		Ordena3 listaOriginal = new Ordena3(tamanho, tipo);
		
	
		System.out.print("CountingSort: ( " + listaOriginal.lista.length + " elementos  - "+getTipo(tipo) + " )" );
		Ordena3 listaCoutingSort = new Ordena3(0,0);
		...
		Ordena3 listaBucketSort = new Ordena3(0,0);
		...
		Ordena3 listaRadixSort = new Ordena3(0,0);
